        ...
        <div class="container mx-auto grid grid-cols-1 p-5 sm:w-full md:w-5/12">
            ...
            <form @submit.prevent="register">
                <div class="bg-white rounded-md shadow-md p-5">
                    ...
                    <div>
                        <button
                            class="bg-sulton-700 py-1 px-3 text-white rounded-md shadow-md text-xl inline-block w-full focus:outline-none focus:bg-sulton-900">DAFTAR</button>
                    </div>
            ...
            <div class="text-center mt-5">
                Sudah punya akun ? <router-link :to="{name: 'login'}" class="underline text-sulton-600">Masuk Disini!</router-link>
            </div>
