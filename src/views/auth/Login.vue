        ...
        <div class="container mx-auto grid grid-cols-1 p-5 sm:w-full md:w-5/12">
            ...
            <form @submit.prevent="login">
                <div class="bg-white rounded-md shadow-md p-5">
                    <div class="text-xl">
                        MASUK AKUN YUK... AGAR KITA SEMAKIN DEKAT
                    </div>
                    ...
                    <div>
                        <button
                            class="bg-sulton-700 py-1 px-3 text-white rounded-md shadow-md text-xl inline-block w-full focus:outline-none focus:bg-sulton-900">MASUK</button>
                    </div>
            ...
            <div class="text-center mt-5">
                Join dulu yuk jadi sahabat Kebaikan <router-link :to="{name: 'register'}" class="underline text-sulton-600">Daftar Sekarang!</router-link>
            </div>
