    ...
    <div class="pb-20 pt-20">
            ...
            <div class="bg-white rounded-md shadow-md p-3">
                ...
                <div v-if="sumDonation.length > 0">
                    <div v-for="donation in sumDonation" :key="donation">
                        ...
                        <p class="mt-4 text-base text-sulton-500">
                ...
                <div v-if="maxDate(campaign.max_date) == true">
                    <div class="mt-5">
                        <button class="bg-sulton-500 py-3 rounded-md shadow-md text-xl w-full uppercase font-bold focus:outline-none opacity-50 cursor-not-allowed">Donasi Ditutup!</button>
                    </div>
                </div>
                <div v-else>
                    <div class="mt-5">
                        <router-link :to="{name: 'donation.create', params:{slug: route.params.slug}}">
                            <button class="bg-sulton-600 py-3 rounded-md shadow-md text-xl w-full uppercase font-bold focus:outline-none focus:bg-yellow-600">Donasi Sekarang!</button>
                        </router-link>
                    </div>
                </div>
        ...
        <div class="container mx-auto grid grid-cols-1 p-3 sm:w-full md:w-5/12">
            ...
            <div class="bg-white rounded-md shadow-md p-3">
                ...
                <div class="bg-sulton-200 p-3 rounded shadow-md mb-3">

                    <div class="grid grid-cols-12">
                        <div class="col-span-2">
                            <img :src="user.avatar" class="w-10 h-10 rounded-full shadow">
                        </div>
                        <div class="col-span-8 text-lg font-bold mt-2">
                            {{ user.name }} <i class=" p-1 fas fa-check-circle"></i>
                        </div>
                    </div>
                </div>
                ...
                <div v-for="donation in donations" :key="donation.id" class="bg-gray-200 p-3 rounded shadow-md mb-3">
                    ...
                    <div class="grid grid-cols-10 gap-4">
                        ...
                        <div class="col-span-9 mt-1">
                            ...
                            <div class="text-sm mt-2 text-sulton-500">
                    ...
                    <div class="grid grid-cols-1 gap-4 mt-3">
                        ...
                        <div class="text-sulton-600 text-sm">
                            {{ donation.pray }}
                        </div>
                       
                        <div class="text-sulton-500 text-sm italic text-right">
                            {{ donation.created_at }}
                        </div>
                    </div>
