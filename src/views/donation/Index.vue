    ...
    <div class="pb-20 pt-20">
        <div class="container mx-auto grid grid-cols-1 p-3 sm:w-full md:w-5/12">
            ...
            <div class="bg-white rounded-md shadow-md p-5">
                ...
                <div class="bg-sulton-400 w-1000 h-900 rounded">
                ...
                <div v-if="donations.length > 0">
                    ...
                    <div class="text-center mt-7" v-show="nextExists">
                        <a @click="loadMore"
                            class="bg-sulton-700 text-white p-1 px-3 rounded-md shadow-md focus:outline-none focus:bg-gray-900 cursor-pointer">LIHAT SEMUA <i class="fa fa-long-arrow-alt-right"></i></a>
                    </div>
