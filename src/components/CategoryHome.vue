    ...
    <div>
        <div v-if="categories.length > 0">
            <div class="mt-5 grid grid-cols-4  gap-4 md:gap-4 text-center items-center">
                <div v-for="category in categories" :key="category.id" class="col-span-2 md:col-span-2 lg:col-span-1 bg-sulton-100 rounded-md shadow-md p-4 text-center text-xs">
                ...
                <div class="col-span-2 md:col-span-1 lg:col-span-1 bg-sulton-100 rounded-md shadow-md p-4 text-center text-xs">
                    <router-link :to="{name:'category.index'}">
                        <div>
                            <img src="@/assets/images/other.png" width="40" class="inline-block mb-2">
                        </div>
                        LAINNYA
                    </router-link>
                </div>
