            ...
            <div class="container mx-auto grid grid-cols-4 gap-4 p-2 sm:w-full md:w-5/12">
                ...
                <div>
                    <router-link :to="{name: 'home'}"
                     class="w-5/6 p-px border-2 border-light-blue-500 border-opacity-50 justify-center inline-block text-center group focus:bg-gray-300 rounded">
                ...
                <div>
                    <router-link :to="{name: 'donation.index'}"
                        ...
                        <span class="block text-xs">DonasiKu</span>
                    </router-link>
                </div>
